...
export default function PricingPage() {
  return (
    <section className="section-center flex items-center justify-center flex-col !min-h-[calc(100vh-56px)] sm:my-0 my-20">
      <h1 className="text-3xl font-bold text-center">Pricing & Plan</h1>
      <p className="mt-2 text-xs text-neutral-400 text-center w-3/4 mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10">
        <div className="w-full xl:min-w-[300px] lg:min-h-[400px] border border-neutral-700 rounded-sm p-4 flex flex-col justify-between">
