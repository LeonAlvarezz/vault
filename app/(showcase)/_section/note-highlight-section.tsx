...
export default function NoteHighlightSection({ notes }: Props) {
  return (
    <section className="min-h-svh relative items-center justify-center flex flex-col">
      ...
      <div className="bg-neutral-800 opacity-50 size-[500px] rounded-full blur-3xl absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 -z-10"></div>
