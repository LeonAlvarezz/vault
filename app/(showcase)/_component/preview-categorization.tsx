...
export default function PreviewCategorization() {
  return (
    <div className="min-h-[300px] w-[500px] border border-neutral-700/50 p-4 mt-6 tiptap rounded-sm relative overflow-hidden animated-border-box scale-[1.3] top-10">
      ...
      <div className="flex gap-1 flex-col">
        ...
        <div className="max-w-[150px] h-24 border border-neutral-700 flex flex-col p-4 gap-2">
