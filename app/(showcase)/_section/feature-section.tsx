...
export default function FeatureSection() {
  return (
    <section className="min-h-svh flex justify-center items-center flex-col sm:mt-4 mt-20 section-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 grid-rows-4 lg:grid-rows-2 gap-3 mt-10 relative ">
        <div
          className={cn(
            "bg-neutral-900 border w-full border-neutral-700/50 p-6 rounded-sm overflow-hidden relative h-[350px]"
            // className
          )}
        >
        ...
        <div
          className={cn(
            "bg-neutral-900 border border-neutral-700/50 p-6 rounded-sm overflow-hidden h-[300px] col-span-1 lg:col-span-3 flex justify-between lg:gap-0 gap-14 lg:flex-row flex-col relative"
          )}
        >
